...
var headerLink = document.querySelectorAll('.navigation-list__link');
header.classList.remove('no-js');
headerToggle.addEventListener('click', function () {
  return header.classList.toggle('is-active');
});
headerToggle.addEventListener('click', function () {
  return header.classList.toggle('modal');
});
headerOverlay.addEventListener('click', function () {
  return header.classList.remove('is-active');
});
headerLink.forEach(function (menu) {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  tel.forEach(function (elem) {
    (function () {
      return new imask__WEBPACK_IMPORTED_MODULE_2__["default"](elem, {
